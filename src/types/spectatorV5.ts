...
export interface BannedChampion {
  ...
  export interface CurrentGameParticipant {
    ...
    teamId: number;                    // The team ID of this participant, indicating the participant's team (100 for blue, 200 for red in 5v5)
    summonerName?: string;             // The summoner name of this participant (Not in spec, but often present)
    riotId?: string;                   // The full Riot ID (GameName#TagLine) if available
    ...
    playerSubteamId?: number;          // The ID of the subteam the player belongs to (e.g., in Arena mode). Added as optional.
  }
